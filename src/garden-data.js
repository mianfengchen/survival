...
CHARACTER_LIBRARY.push(
  ...[
    ["glassprout", "玻璃棱镜芽灵", "万花折光师", "花灵", "把温室晨光炼成会不断折射的棱光，越折越亮、越折越多，一束光洗遍整片敌阵。", "glassPrismRay", "#7fd8ff"],
    ["honeybell", "蜜铃陷阱师", "黏沼爆破手", "花朵", "投出蜜糖软弹，炸开后原地留下黏稠蜜沼，把踩进来的害虫牢牢粘住慢慢消融。", "honeyBomb", "#f0b95f"],
    ["rainroot", "棘纹雨圈守望", "倒刺符阵师", "植物", "既能画雨圈治疗队友，也能在符阵里生出倒刺荆纹，让踏入的害虫边被拖慢边流血灼伤。", "rainRootSigil", "#78d4b5"],
    ["orchidnova", "醉兰坠星者", "花粉催化师", "花灵", "召来兰色种星，绽弹拖着醉人花粉，中招的害虫既被减速、又会承受成倍伤害。", "orchidComet", "#d69cff"],
    ["bramblebee", "荆丛播种骑士", "疯长荆棘师", "益虫", "掷出会疯长的棘种，转眼铺成缠人荆棘丛，枯萎时还会崩出满地棘刺。", "brambleBoomerang", "#9bcf63"],
    ["dewdropper", "涟露连爆工匠", "连锁水雷师", "植物", "埋下露珠雷种，引爆后水珠一路连锁迸溅，每炸一颗都为自己回一口血。", "dewdropMine", "#8adfd6"],
    ["stormlily", "雷网织缎者", "连锁落雷师", "花灵", "让电光缎带落雷，雷电顺着虫群一路结成雷网，边跳边麻痹成片敌人。", "stormRibbon", "#9fb8ff"],
    ["moonwell", "月痕缠缚者", "破防捕手", "景观守灵", "从月井牵出柔藤缠住高威胁目标，被缠者会被烙上月痕，之后承受的一切伤害都被放大。", "moonwellSnare", "#ef91c2"],
    ["lanternbud", "薪火烙印手", "连爆点灯人", "植物", "把火花烙进害虫体内，越烙越多，目标一死便掀起连环爆燃点燃周围一片。", "lanternSpark", "#f4c86d"],
    ["harvestdoll", "断魂收割偶", "裂割镰手", "花朵", "抛出回旋镰月贯穿虫阵，命中时崩出侧向月牙碎片，返程更快还能借势加速。", "harvestCrescent", "#ee7778"],
    ["seedvault", "寄生种脉守钥", "芽孢侵蚀师", "花灵", "释放种脉脉冲，被扫过的害虫种下寄生芽孢，持续侵蚀生命并把养分回流给自己。", "seedvaultPulse", "#badb69"],
    ["pearlshell", "珠爆霰射贝苗", "碎珠溅射师", "植物", "吹出珍珠泡泡，爆裂时四散射出会追击的珍珠碎片，覆盖一整片战线。", "pearlBubble", "#f1d18a"],
    ["clockivy", "凝时藤鞭师", "定身修理匠", "植物", "校准藤鞭节拍抽向害虫，抽中的瞬间将其冻结在时间里，定身后再引爆。", "clockIvyLash", "#7bc489"],
    ["operamoth", "致弱鳞粉伶", "催眠丝刃者", "益虫", "唱出弧形丝刃并洒落致幻鳞粉，命中的害虫被减速，还会在一段时间里更容易受伤。", "operaMothBlade", "#c6a0f2"],
    ["antlerleaf", "贯地枝角童", "分叉突刺手", "花灵", "掷出晶角标枪强力贯穿，命中时向两侧再岔出分叉鹿角，串起整排敌人。", "antlerBolt", "#73d1ff"],
    ["sporecup", "孢潮茶杯侍者", "蔓延菌雾师", "植物", "摆下茶杯菌雷，触发后喷出会不断扩散、毒性层层加深的菌雾长时间盘踞。", "sporeTeacupMine", "#b8c978"],
    ["tulipbolt", "雷池郁金芽", "残雷布阵师", "花朵", "在害虫脚下点亮花杯落雷，落点绽开残留雷池，持续电击并减速滞留其中的敌人。", "tulipThunder", "#ffab86"],
    ["eclipsebud", "蚀骨牡丹芽", "易伤坠瓣师", "花灵", "召下暗粉花瓣流星，被笼罩的害虫陷入蚀骨易伤，之后受到的所有伤害都大幅加重。", "eclipsePetalRain", "#f073a4"],
    ["blueflame", "湛蓝业火苗", "蓝焰纵火者", "景观守灵", "铺开蓝焰花田，点燃踏入的害虫附加剧烈灼烧，层层叠加越烧越猛。", "blueflameGarden", "#92a7ff"],
    ["scissorvine", "裂创剪影偶", "交叉剪藤师", "植物", "让刃状藤蔓交叉剪切，交汇处爆开裂创花棘波及周围，并留下持续流血。", "scissorVine", "#ef6872"],
    ["royalbud", "御苑回春苞", "汲血脉冲师", "花朵", "展开皇冠脉冲扫荡近身，脉冲每命中一个害虫便为自己回一分血，敌越多回得越多。", "royalBudPulse", "#a8d46b"],
    ["ambergear", "嵌地锯盘芽", "齿轮陷阱师", "植物", "抛出旋转齿轮，嵌进地里化作锯盘力场，持续绞磨并减速停留其上的害虫。", "amberGearBurst", "#f1b86b"],
    ["aurorapetal", "极光贯羽花瓣", "穿透针雨手", "花灵", "洒下极光针雨，针羽获得强穿透，像串糖葫芦般贯穿整排敌人不再消失。", "auroraNeedle", "#c9a9ff"],
    ["grandprism", "碎界棱镜守心", "终庭坠晶师", "景观守灵", "引导巨型棱镜彗星坠落，炸出成群追踪碎棱星，并让命中的害虫破碎易伤。", "grandPrismMeteor", "#72cbff"],
